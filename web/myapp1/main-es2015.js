...
let AddTeacherComponent = class AddTeacherComponent {
    constructor(route, departmentService, teacherService, location) {
        this.route = route;
        this.departmentService = departmentService;
        this.teacherService = teacherService;
        this.location = location;
    }
    ngOnInit() { this.getDepartments(); }
    getDepartments() {
        this.departmentService.getDepartments()
            .subscribe(res => this.departments = res);
    }
    save(name, department, title, degree) {
        // @ts-ignore
...
module.exports = __webpack_require__(/*! C:\Users\10673\Desktop\javaweb\1\myapp\src\main.ts */"./src/main.ts");
