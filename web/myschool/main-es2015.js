...
let SchoolService = class SchoolService {
    constructor(http) {
        this.http = http;
        this.collegeUrl = '../school/'; //sevlet的相对路径，
    }
    ...
    getCollege(id) {
        const url = this.collegeUrl + 'update.ctl?id=' + id;
    ...
    updateCollege(college) {
        return this.http.post(this.collegeUrl + 'update.ctl', college, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('updateCollege')));
    }
    /**
...
module.exports = __webpack_require__(/*! C:\Users\10673\Desktop\myschool2\src\main.ts */"./src/main.ts");
