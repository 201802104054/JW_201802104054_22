...
//请使用以下JSON测试增加功能（id为空）
    ...
    /**
     * POST, http://49.235.39.226:8080/profTitle.ctl, 增加学院
    ...
    /**
     * DELETE, http://49.235.39.226:8080/profTitle.ctl?id=1, 删除id=1的学院
    ...
    /**
     * PUT, http://49.235.39.226:8080/profTitle.ctl, 修改学院
     *
    ...
    /**
     * GET, http://49.235.39.226:8080/profTitle.ctl?id=1, 查询id=1的学院
     * GET, http://49.235.39.226:8080/profTitle.ctl, 查询所有的学院
     * 把一个或所有学院对象响应到前端
     * @param request
     * @param response
     * @throws ServletException
