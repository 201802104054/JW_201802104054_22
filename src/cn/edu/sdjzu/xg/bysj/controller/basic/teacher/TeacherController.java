...
//请使用以下JSON测试增加功能（id为空）
    ...
    /**
     * POST, http://49.235.39.226:8080/teacher.ctl, 增加学院
     * 增加一个学院对象：将来自前端请求的JSON对象，增加到数据库表中2
     * @param request 请求对象
     * @param response 响应对象
    ...
    /**
     * DELETE, http://49.235.39.226:8080/teacher.ctl?id=1, 删除id=1的学院
    ...
    /**
     * PUT, http://49.235.39.226:8080/teacher.ctl, 修改学院
     *
    ...
    /**
     * GET, http://49.235.39.226:8080/teacher.ctl?id=1, 查询id=1的学院
     * GET, http://49.235.39.226:8080/teacher.ctl, 查询所有的学院
     * 把一个或所有学院对象响应到前端
     * @param request
     * @param response
     * @throws ServletException
